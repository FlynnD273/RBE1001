...
motor MotorsLifterMotorA = motor(PORT11, ratio18_1, false);
motor MotorsLifterMotorB = motor(PORT20, ratio18_1, true);
motor_group MotorsLifter = motor_group(MotorsLifterMotorA, MotorsLifterMotorB);
motor MotorClaw = motor(PORT4, ratio18_1, true);
